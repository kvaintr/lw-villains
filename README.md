...
The auction in my opinion can be considered fair if it's done at max_bid which profits both the liquidator and allows the player to continue his participation in the competition. However with buying all the collateral at almost 0 cost should be treated as transfer of capital which can be hidden or not.
